...
<header class="sticky top-0 z-50 w-full border-b border-white/10 bg-[#05070d]/80 backdrop-blur-md">
  <div class="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-10">
    ...
    <!-- Logo -->
    <a href="index.php" class="text-2xl font-bold tracking-tight text-white transition hover:text-red-400">
      Fast<span class="text-red-500">Racers</span>
    </a>
    
    <!-- Menu -->
    <nav class="hidden md:block">
      <ul class="flex items-center gap-8 text-sm font-medium uppercase tracking-wide text-white/70">
        <li><a href="index.php" class="transition hover:text-white">Accueil</a></li>
        <li><a href="testproduits.php" class="text-white">Boutique</a></li>
        <li><a href="contact.php" class="transition hover:text-white">Contact</a></li>
      </ul>
    </nav>
